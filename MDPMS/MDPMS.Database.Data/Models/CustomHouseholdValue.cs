...
{
    public class CustomHouseholdValue : EfBaseModel, ISyncableAsChild<CustomHouseholdValue>, ISyncableWithCustomFieldSecondParent<CustomHouseholdValue>
    {
        ...
        public int? InternalParentId { get; set; } = null; // Household
        ...
        public int? ExternalParentId { get; set; } = null; // Household
        ...
        public CustomHouseholdValue GetObjectFromJson(dynamic json)
        {
            var customHouseholdValue = new CustomHouseholdValue
            {
                ExternalId = json.id,
            ...
            return customHouseholdValue;
        }

        public bool GetObjectNeedsUpate(CustomHouseholdValue checkUpdateFrom)
        {
        ...
        public void UpdateObject(CustomHouseholdValue updateFrom)
        {
        ...
        public Tuple<int, CustomHouseholdValue> GetObjectFromJsonWithParentId(dynamic json, string parentIdPropertyName)
        {
            int id = json.parentIdPropertyName;
            CustomHouseholdValue value = GetObjectFromJson(json);
            return new Tuple<int, CustomHouseholdValue>(id, value);
        }

        public string GenerateUpdateJsonFromObject(CustomHouseholdValue updateFrom)
        {
        ...
        public void SetIds()
        {
            ...
            if (Household == null)
            {
                var parentModelQuery = MdpmsDatabaseContext.Households.Where(a => a.GetExternalId() == ExternalParentId);
                if (parentModelQuery.Any()) Household = parentModelQuery.First();
            }

#!/bin/bash
# Add a migration to MDPMS.Database.Data
...
DIRS_TO_COPY=('MDPMS/MDPMS.Database.Data/Database' 'MDPMS/MDPMS.Database.Data/Models' 'MDPMS/MDPMS.Database.Data/Models/Base')
...
EXISTING_MIGRATIONS_PATH=$MDPMS_SLN_DIR/MDPMS/MDPMS.Database.Data/Migrations
